{ lib, bazel_4, buildBazelPackage, fetchFromGitHub, fetchpatch, stdenv, cmake
, gn, go, jdk, ninja, python3, linuxHeaders, nixosTests
...
in buildBazelPackage rec {
  ...
  patches = [
    ...
    (fetchpatch {
      url =
        "https://github.com/envoyproxy/envoy/commit/68448aae7a78a3123097b6ea96016b270457e7b8.patch";
  ...
  fetchAttrs = {
    sha256 = {
      x86_64-linux = "sha256-l/aKcT439JZTNGO4tQM87yVoEPRjRujfUkA2Am5q9iM=";
